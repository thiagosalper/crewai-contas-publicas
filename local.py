...
dataset_path = './csv/small_despesas.csv'  # Replace with your local file path
...
cleaned_dataset_path = './csv/cleaned_example_dataset.csv'
...
csv_tool = FileReadTool(file_path='./csv/cleaned_example_dataset.csv')
...
markdown_report_task = Task(
    ...
    context=[dataset_inference_task, data_analysis_task],
...
csv_analysis_crew = Crew(
    ...
    tasks=[dataset_inference_task, data_analysis_task, markdown_report_task],
